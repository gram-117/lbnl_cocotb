...
async def pixel_test(dut):
  ...
  #   # =========================================================================
    ...
    hit_duration = 4  # BX clocks
    pixel_mask = 63  # pixel 0 only

    dut.TrigIdIn.value = 1 # try keeping trig 1 
    dut.TrigIdReqIn.value = 1 # req same trig 
  ...
  #   # Inject hit
    ...
    dut._log.info(f"region0 data = {dut.PixelRegion[0].PixelRegionLogic.DataToCore.value}")
    dut.TrigIn.value = 1
